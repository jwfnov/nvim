  ...
  lspconfig.pyright.setup({
    ...
    settings = {
      python = {
        ...
        pythonPath = "C:\\Users\\oven\\miniconda3\\envs\\py313\\python.exe",  -- setting this would cause "import not resolved" warning for packages not installed in this python env
      }
    },
